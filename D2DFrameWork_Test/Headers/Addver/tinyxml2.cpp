...
namespace tinyxml2
{
	...
	*/
	...
	bool XMLUtil::ToBool(const char* str, bool* value)
	{
		...
		static const char* _TRUE[] = { "true", "True", "TRUE", 0 };
		static const char* _FALSE[] = { "false", "False", "FALSE", 0 };

		for (int i = 0; _TRUE[i]; ++i) {
			if (StringEqual(str, _TRUE[i])) {
				*value = true;
				return true;
			}
		}
		for (int i = 0; _FALSE[i]; ++i) {
			if (StringEqual(str, _FALSE[i])) {
				*value = false;
				return true;
			}
		}
